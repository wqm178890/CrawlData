...
class SeleniumCreateAd(unittest.TestCase):
    ...
    def test_selenium_create_ad(self):
        ...
        time.sleep(2.0)
        #/html/body/div[5]/div/div/div/div/div[2]/table/tbody/tr[1]/td/span
        ...
        file_object = open('%sGDTNativeLargePlacementId.txt'%xml_path, 'w')
        file_object.write("%s"%(source_detail_id))
        file_object.close()
