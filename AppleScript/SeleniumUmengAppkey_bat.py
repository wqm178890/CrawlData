...
class SeleniumUmengAppkey(unittest.TestCase):
    ...
    def test_selenium_umeng_appkey(self):
        ...
        driver.find_element_by_css_selector("input[type=\"text\"]").send_keys("beenice@qq.com")
        driver.find_element_by_css_selector("input[type=\"password\"]").clear()
        driver.find_element_by_css_selector("input[type=\"password\"]").send_keys("Beemans91")
