...
def Proxy_read(proxy_list, user_agent_list, i):
    ...
    print(u'当前代理ip：%s'%proxy_ip)
    user_agent = random.choice(user_agent_list)
    print(u'当前代理user_agent：%s'%user_agent)
    sleep_time = random.randint(1,3)
    print(u'等待时间：%s s' %sleep_time)
    ...
    req = urllib2.Request(r'http://blog.csdn.net/u010620031/article/details/51068703',headers=headers)
    try:
